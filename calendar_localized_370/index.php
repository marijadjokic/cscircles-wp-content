...
<pre>- Credits go to <a href="mailto:ciprianmp@yahoo.com?subject=Localized%20Calendar%20Class%20feedback" target="_blank">Ciprian Murariu</a>, with the kind help of <a href="http://ciprianmp.com/plus/" target="_blank">phpMyChat-Plus</a> translators, based on <b><font color=red>3.70</font></b> version TJ's class above -</pre>
<h3><a href="http://ciprianmp.com/scripts/calendar/calendar_localized_369.zip" target="_blank">Download this multi-language version here.</a> <a href="calendar/change_log.txt" target="_blank">Read what's new...</a></h3>
	<div id="fb-root"></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="5">
		<tr>
		  <td colspan=2><b>Available in 42 languages and dialects:</b> Arabian, Argentinian Spanish, Armenian, Brasilian Portuguese, Bulgarian, Catalan, Chinese (Simplified and Traditional), Czech, Danish, Deutch, Dutch, English (US & GB), Farsi (Persian), Finnish, French, Greek, Hebrew, Hindi (Devanagari), Hungarian, Indonesian (Bahasa Indonesia), Italian, Japanese, Korean, Macedonian, Malaysian (Bahasa Melayu), Norwegian (Bokmål & Nynorsk), Polish, Portuguese, Romanian, Russian, Serbian (Latin), Slovak, Spanish, Swedish, Thai, Turkish, Ucrainean, Vietnamese, Yoruba (and counting...)<br />
...
<!-- START OF: Needed for the manual Language selector - not needed if you pass the LANG from your own script -->
		...
		<?php
		echo ("<select name=\"hl\" class=\"font\" onChange=\"this.form.submit()\">");
			$j = 1;
...
<!-- END OF: Needed for the manual Language selector - not needed if you pass the LANG from your own script -->
	  ...
	  $myCalendar->setYearInterval(1900, 2100);
	  ...
	  ?></td>
                  <td valign="top"><ul>
                    ...
                    <li>Set year navigate from 1970 to 2040</li> <!-- Ciprian comment: It doesn't work if you also activate dateAllow. The setYearInterval has no effect then! -->
              ...
              <p><b>Code:</b></p>
              <pre>&lt;?php<br />	  $myCalendar = new tc_calendar(&quot;date1&quot;);<br />	  $myCalendar-&gt;setDate(date(&quot;d&quot;), date(&quot;m&quot;), date(&quot;Y&quot;));<br />	  $myCalendar-&gt;setPath(&quot;calendar/&quot;);<br />	  $myCalendar-&gt;setYearInterval(1970, 2040);<br />	  $myCalendar-&gt;dateAllow(&quot;2008-05-13&quot;, &quot;2015-03-01&quot;, false);<br />	  $myCalendar-&gt;disabledDay(&quot;sat&quot;);<br />	  $myCalendar-&gt;disabledDay(&quot;sun&quot;);<br />	  $myCalendar-&gt;setSpecificDate(array(&quot;2011-04-01&quot;, &quot;2011-04-14&quot;, &quot;2011-04-25&quot;), 0, &quot;month&quot;);<br />	  $myCalendar-&gt;writeScript();<br />?&gt;</pre>
...
<!-- END OF: Needed for checking the selected value - not needed in your own script -->
			  ...
			  then:
              <pre>&lt;?php<br />	  $myCalendar = new tc_calendar(&quot;date2&quot;, <b>true</b>);<br />	  $myCalendar-&gt;<b>setAutoHide(false)</b>;<br />	  $myCalendar-&gt;setDate(date(&quot;d&quot;), date(&quot;m&quot;), date(&quot;Y&quot;));<br />	  $myCalendar-&gt;setPath(&quot;calendar/&quot;);<br />	  $myCalendar-&gt;setYearInterval(1960, date(&quot;Y&quot;));<br />	  $myCalendar-&gt;dateAllow(&quot;1960-01-01&quot;, date(&quot;Y-m-d&quot;));<br />	  $myCalendar-&gt;setAlignment(&quot;left&quot;, &quot;bottom&quot;);<br />	  $myCalendar-&gt;disabledDay(&quot;sun&quot;);<br />	  $myCalendar-&gt;setSpecificDate(array(&quot;2011-04-01&quot;, &quot;2011-04-14&quot;, &quot;2010-12-25&quot;), 0, &quot;year&quot;);<br />	  $myCalendar-><b>setOnChange("myChanged('Test message')")</b>;<br />	  $myCalendar-&gt;writeScript();<br />?&gt;</pre>
